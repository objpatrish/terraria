...
ENV APP_URL='https://terraria.org/system/dedicated_servers/archives/000/000/038/original/terraria-server-1404.zip' \
...
# Set up Enviornment
RUN \
    curl -sL ${APP_URL} --output /tmp/terraria-server.zip && \
